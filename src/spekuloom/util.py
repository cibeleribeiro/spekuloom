...
class Mont:
    ...
    def mont_symbol_pt(self):

        # classes=dict(noun,article,adjective, verb, adverb, preposition, conjuction,interjection, pronoun)
        classes = dict(NOU="\033[1;30m" + u"\u25B2" + "\033[1;0m",
                       DET="\033[1;36m" + u"\u25B4" + "\033[1;0m",
                       ADJ="\033[1;34m" + u"\u25ED" + "\033[1;0m",
                       VER="\033[1;31m" + u"\u25CF" + "\033[1;0m",
                       MD="\033[1;31m" + u'\u25cc' + "\033[1;0m",
                       ADV="\033[1;31m" + u"\u25CB" + "\033[1;0m",
                       ADP="\033[1;32m" + u"\u25E1" + "\033[1;0m",
                       CON="\033[1;35m" + u"\u25AC" + "\033[1;0m",
                       UH="\033[1;33m" + u"\u25C8" + "\033[1;0m",
                       PRO="\033[1;35m" + u"\u25BB" + "\033[1;0m",
                       ZZ="\033[1;33m" + u"\u25A4" + "\033[1;0m",
                       WD="\033[1;36m" + u"\u25A5" + "\033[1;0m",
                       WP="\033[1;35m" + u"\u25A6" + "\033[1;0m",
                       WR="\033[1;31m" + u"\u25A7" + "\033[1;0m",
